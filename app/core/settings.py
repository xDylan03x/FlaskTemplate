...
settings = [
    ...
    SettingSpec(key="Security Alerts via Email", group="Notifications", description="Receive security alerts", default=True),
    SettingSpec(key="Security Alerts via Text", group="Notifications", description="Receive security alerts", default=False),
