...
# Instructions
To view and modify system settings or the admin panel, click on the "System" tab in the system settings menu (you must have one of the above permissions to see this option).
...
_Note: You must have the "Admin System" permission to view the admin panel._  
